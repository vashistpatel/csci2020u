...
set CLASSPATH=%APP_HOME%\lib\lab03.jar;%APP_HOME%\lib\commons-csv-1.7.jar

@rem Execute lab03
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAB03_OPTS%  -classpath "%CLASSPATH%" gradleDemo.Demo %CMD_LINE_ARGS%
